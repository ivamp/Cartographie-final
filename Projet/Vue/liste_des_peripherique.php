<div class="row cadreRubrique">
    <div class="col-xs-12">
        ...
        <div class="col-xs-2">
            <p class="titreRubrique">Périphériques</p>
        </div>
        <div class="col-xs-2">
    ...
    <?php
        for ($x = 0; $x < count($listeMachine->getListePeripherique()); $x++) {
        $machine = $listeMachine->getListePeripherique()[$x];
        $adresseIP = "'" . $machine->getIp() . "'";
        $listePortMachine=$machine->getListePort();
        if (empty($listePortMachine)) {
            echo '
            ...
            ';
                    ...
                    echo'
            <div class = "col-xs-12  margeTop20" id = "">
